...
plt.xlabel('{} [{}]'.format(x_name,x_units))
plt.ylabel('{} [{}]'.format(y_name,y_units))
plt.title(r'Linearity of LF411 $V_{out}$ vs $V_{in}$ with G=Rf/Rg=4')

# show a legend. loc='best' places legend where least amount of data is obstructed. 
plt.legend(loc='best',numpoints=1)
